...
[事前計画](../results/E039-capacity-admission/PROTOCOL.md) / [生データ](../results/E039-capacity-admission/run/results.json) / [凍結設定](../results/E039-capacity-admission/run/frozen_manifest.json) / [監査](../results/E039-capacity-admission/run/audit_summary.json)
