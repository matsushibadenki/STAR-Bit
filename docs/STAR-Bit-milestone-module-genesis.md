...
実行期間：2026-09-12〜2026-09-22。E017〜E036は、primitive論理演算から中間Functionを形成し、Libraryへ昇格・選別・移植できるかを段階的に検証した。
...
- [Next] 新規独立seedで両taskの移植なし／Function／barrier／random／inertを各task内の同一予算で比較する。
